 ...
 *         Valenciana
 * 
 *         The UpgradeDeck class has one field: ArrayList<Card> deckOfCards.
...
public class UpgradeDeck implements Deck {
	...
	public Card createCard(String cardInfo[]) throws FileNotFoundException {
		return new Card(cardInfo[0], cardInfo[1], new Image(new FileInputStream("src/images/developers-hand-logo.png")), cardInfo[2], Color.LIMEGREEN);
	}
